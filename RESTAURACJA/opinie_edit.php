            ...
            else
            {
                ...
                for($i=0; $i<$how_many; $i++)
                {
                    if($opinion[$i]["LoginID"] == $loginID)
                    {
                        ...
                        <div id="frame_com">
                            <div id="block">
                                    <div id="com_text">
                                    <form method="post">
                                        <input id="opinion" type="text" name="'; print($i); echo'" value="'; print($opinion[$i]["text"]); echo'"><br/>     
                                        <div id="com_edit">
                                            <button id="none">
                                            <a href="#">
                    ...
                    if(isset($_POST[$i]))
                    {
                        $id_op = $_GET['id_op'];
                        $new_text = $_POST[$i];
                        if($new_text!=$opinion[$i]["text"])
                        {
                            if($connected->query("UPDATE `opinions` SET `text` = '$new_text' WHERE `opinions`.`OpinionID` = '$id_op'"))
                            {
